...
search of this historically significant facility, an Elf operating a [very familiar printer](./2017_01.md) beckons you
over.
...
- 61 is correctly in the middle because 75 and 47 are before it (`75|61` and `47|61`) and 53 and 29 are after it (
  `61|53` and `61|29`).
- 53 is correctly fourth because it is before page number 29 (`53|29`). 29 is the only page left and so is correctly
  last.
