...
mod does_contain_two_characters_in_a_row {
    ...
    fn when_input_have_same_characters_at_the_beginning() {
        assert_eq!(
            super::does_contain_same_characters_in_a_row("aaqwertyuiop"),
            true
        );
    }
    #[test]
    fn when_input_have_same_characters_at_the_end() {
        assert_eq!(
            super::does_contain_same_characters_in_a_row("qwertyuiobb"),
            true
        );
    }
    #[test]
    fn when_input_have_same_characters_at_the_middle() {
        assert_eq!(
            super::does_contain_same_characters_in_a_row("qwertyuiggxcvbnm"),
            true
        );
    }
    #[test]
    fn when_input_does_not_have_same_characters() {
        assert_eq!(
            super::does_contain_same_characters_in_a_row("asdfghjkl"),
            false
        );
    }
}
...
mod does_contain_vowel {
    ...
    fn when_input_have_three_different_vowel() {
        assert_eq!(
            super::does_contain_three_vowel("dsmkvdsflfanjkfvkejdlkdsuvjkn"),
            true
        );
    }
    #[test]
    fn when_input_have_two_different_vowel() {
        assert_eq!(
            super::does_contain_three_vowel("djxxsnxbuhdjsdkdncxboxgsjxn"),
            false
        );
    }
    #[test]
    fn when_input_does_not_have_vowel() {
        assert_eq!(
            super::does_contain_three_vowel("qwrtypsdfghjklzxcvbnm"),
            false
        );
    }
}
...
mod does_contain_repeating_two_letters {
    ...
    fn when_repeating_character_at_the_beginning_and_end() {
        assert_eq!(
            super::does_contain_repeating_two_letters("aafghjmnnjjjaa"),
            true
        );
    }
    #[test]
