...
use solver::{
    ...
    Solver2022_01, Solver2022_02, Solver2022_03, Solver2022_04, Solver2022_05, Solver2022_06,
    Solver2022_07, Solver2022_08, Solver2022_09, Solver2022_10, Solver2022_11, Solver2022_12,
    Solver2022_13, Solver2022_14, Solver2022_15, Solver2022_16, Solver2022_17, Solver2022_18,
    Solver2022_20, Solver2022_21, Solver2022_22, Solver2024_01, Solver2024_02, Solver2024_03,
    Solver2024_04, Solver2024_05, Solver2024_06, Solver2024_07, Solver2024_08, Solver2024_09,
    Solver2024_10, Solver2024_11, Solver2024_12, Solver2024_13, Solver2024_14, Solver2024_15,
    Solver2024_16, Solver2024_17, Solver2024_18, Solver2024_19, Solver2024_20, Solver2024_21,
    Solver2024_22, Solver2024_23, Solver2024_24, Solver2024_25,
};
...
fn main() {
    ...
    match (args.year, args.day) {
        ...
        (Year::Year2015, Day::Day2) => solve(Box::new(Solver2015_02::default())),
        (Year::Year2015, Day::Day3) => solve(Box::new(Solver2015_03::default())),
        ...
        (Year::Year2015, Day::Day12) => solve(Box::new(Solver2015_12::default())),
        (Year::Year2015, Day::Day13) => solve(Box::new(Solver2015_13::default())),
        (Year::Year2015, Day::Day14) => solve(Box::new(Solver2015_14::default())),
        (Year::Year2015, Day::Day15) => solve(Box::new(Solver2015_15::default())),
        (Year::Year2015, Day::Day16) => solve(Box::new(Solver2015_16::default())),
        (Year::Year2015, Day::Day17) => solve(Box::new(Solver2015_17::default())),
        (Year::Year2015, Day::Day18) => solve(Box::new(Solver2015_18::default())),
        ...
        (Year::Year2022, Day::Day4) => solve(Box::new(Solver2022_04::default())),
        ...
        (Year::Year2024, Day::Day25) => solve(Box::new(Solver2024_25::default())),
